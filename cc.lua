...
sply:write(tonumber(startb))
sply:write(tonumber(VER))
sply:write(tonumber(Len))
sply:write(tonumber(CMD))
sply:write(tonumber(Feedback))
sply:write(tonumber(para1))
sply:write(tonumber(para2))
sply:write(tonumber(checksumpart1))
sply:write(tonumber(checksumpart2))
sply:write(tonumber(endb))
